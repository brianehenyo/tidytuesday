...
tidy_anime %>% 
  ...
  geom_point(alpha = 0.3, aes(color = type, size = scored_by)) +
  ...
  labs(x = "", y = "Score",
       title = "Marred Hametsu no Mars",
       subtitle = "Hametsu no Mars still a favorite despite its rip-off and awful plot",
